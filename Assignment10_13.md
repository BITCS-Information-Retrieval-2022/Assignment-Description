...
+ ScienceDirect：[https://www.sciencedirect.com](https://www.sciencedirect.com/)
  + 含标题、作者、摘要、关键词、PDF链接（验证是否可下载）等论文相关信息
  + [sample here](https://www.sciencedirect.com/science/article/pii/S254243512200410X)
#### 要求
...
+ 要求展示模块提供`任务名称网络信息`、`论文题目网络信息`、`论文方法网络信息`、`论文数据集网络信息`
...
+ 需要可以查看PPT和电子书对应的PPT和视频，设计方法**去杂去重**，保证对齐的准确率

![image-20221013110638629](https://s1.ax1x.com/2022/10/13/xa6yRg.png)


+ 可以自己实现搜索算法，也可以使用已有的搜索引擎工具，比如[Elasticsearch](https://www.elastic.co/)
+ 要求展示模块提供`论文电子书检索列表`、`PPT视频查看按钮`、`论文方法`、`论文数据集网络信息`
+ 要求说明筛选PPT和视频的方法原理
